...
* Chapter: 8
*
* ex_08-04.c -- Character counting
*
* Author: Lee Howard
*
* Date: 03/18/2021
*
* Purpose: Practice input characters streams
*
* Usage: 
*       input characters outputs count
*       
*
********************************************************/
...
/*
    ...
    a word. Actually, punctuation shouldn’t be counted either,
    but don’t worry about that now. (If you do want to worry about
    it, consider using the ispunct() function from the ctype.h
    family.)
